...
// Global chat form instance
ChatForm* g_pChatForm = nullptr;
                      ...
                      _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInst, IDC_WINDOWSPROJECT, szWindowClass, MAX_LOADSTRING);
    MyRegisterClass(hInst, szWindowClass);

    // Create the chat form directly (no main window needed)
    g_pChatForm = new ChatForm(nullptr);
