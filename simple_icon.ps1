...
# Create a simple cyberpunk icon
...
# Save as ICO
$bitmap.Save("WindowsProject\cyberpunk.ico", [System.Drawing.Imaging.ImageFormat]::Icon)

# Create 16x16 version
$bitmap16 = New-Object System.Drawing.Bitmap(16, 16)
$graphics16 = [System.Drawing.Graphics]::FromImage($bitmap16)
$graphics16.Clear([System.Drawing.Color]::FromArgb(0, 20, 0))
$pen16 = New-Object System.Drawing.Pen([System.Drawing.Color]::FromArgb(0, 255, 0), 1)

# Draw smaller version
$graphics16.DrawRectangle($pen16, 1, 1, 14, 14)
$graphics16.DrawLine($pen16, 4, 4, 12, 4)
$graphics16.DrawLine($pen16, 4, 6, 10, 6)
$graphics16.DrawLine($pen16, 4, 8, 11, 8)
$graphics16.DrawLine($pen16, 4, 10, 9, 10)
$graphics16.DrawLine($pen16, 4, 12, 12, 12)

$bitmap16.Save("WindowsProject\cyberpunk_small.ico", [System.Drawing.Imaging.ImageFormat]::Icon)
...
Write-Host "Cyberpunk ICO files created successfully!"
